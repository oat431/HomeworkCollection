...
public class EquipPane extends ScrollPane {
    ...
    ImageView weaponImg = new ImageView();
    ImageView armorImg = new ImageView();
    bg1.setImage(new Image(getClass().getClassLoader().getResource("intro_to_rpg/assets/blank.png").toString()));
    bg2.setImage(new Image(getClass().getClassLoader().getResource("intro_to_rpg/assets/blank.png").toString()));
