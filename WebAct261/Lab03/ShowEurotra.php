...
<body>
    <p><?php echo "The distance from ".$_GET['Start']." to ".$_GET['End']." is ".$Distances[$_GET['Start']][$_GET['End']]." kilometers, or ".number_format($Distances[$_GET['Start']][$_GET['End']] * 0.62137119,2) ." miles.";?></p>
