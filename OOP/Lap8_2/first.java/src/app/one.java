...
public class one{
    public static void main(String[] args) {
		...
		sem1.AddCourse(c3);
		sem1.AddCourse(c13);
		sem1.AddCourseGrade("001101","W");
		sem1.AddCourseGrade("206113", "I");
		sem1.AddCourseGrade("259109","C");
		sem1.AddCourseGrade("751100","C");
		sem1.AddCourseGrade("953101","C");
		sem1.AddCourseGrade("955100","S");
	...
	public static void PrintTranscriptInfo(StudentRegistrationInfo sinfo)
	{
		...
		for(int i = 0; i < sinfo.rec.length;i++)
		{
            ...
            totalcountcredd = totalcountcredd + sinfo.rec[i].GetSemesterCreditss();
			totalgval = totalgval + sinfo.rec[i].GetTotalGval();
			System.out.println("Total Result ="+ totalcountcred +" credits with GPA = "+ totalgval/totalcountcredd);
			System.out.println(" ");
			}
		}
	}
